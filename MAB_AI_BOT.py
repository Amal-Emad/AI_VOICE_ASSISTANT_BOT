...
class SpeechRecognitionApp:
    def __init__(self, master):
        ...
        for idx, voice in enumerate(voices):
           print(f"Voice {idx} - ID: {voice.id}, Name: {voice.name}, Languages: {voice.languages}, Gender: {voice.gender}")
    ...
    def create_ui(self):
        ...
        # Names in bold
        ttk.Label(main_frame, text="By Amal", font=('Helvetica', 10, 'bold')).grid(row=6, column=0, columnspan=3, pady=5, sticky=tk.W)
